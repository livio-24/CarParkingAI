...
public class CarAgent2Level2 : Agent
{
    private Rigidbody rb;
    private PrometeoCarController controller;
    private SimulationManagerLevel2 simulationManager;
    private ParkingLotLevel2 nearestLot;
    ...
    void Start()
    {
        ...
        simulationManager = GetComponent<SimulationManagerLevel2>();
        //simulationManager.OccupyFixedParkingLots();
    ...
    {
        if (simulationManager.initComplete)
        {
            if (nearestLot == null)
            {
