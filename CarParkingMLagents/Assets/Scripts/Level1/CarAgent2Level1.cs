...
public class CarAgent2Level1 : Agent
{
    private Rigidbody rb;
    private PrometeoCarController controller;
    private SimulationManagerLevel1 simulationManager;
    private ParkingLotLevel1 nearestLot;
    ...
    void Start()
    {
        ...
        simulationManager = GetComponent<SimulationManagerLevel1>();
